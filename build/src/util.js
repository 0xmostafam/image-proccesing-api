...
// resize logic
const resizeImage = (imagePath, imageHeight, imageWidth, newImagePath) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
const manipulateImage = (imagePath, imageHeight, imageWidth) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (yield (0, exports.checkImageExists)(newImagePath)) {
        return newImagePath;
    }
